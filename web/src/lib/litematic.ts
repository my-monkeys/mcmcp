    ...
    value: {
      ...
      Metadata: {
        ...
        value: {
          ...
          TimeCreated: ({ type: 'long', value: [Number((now >> 32n) & 0xffffffffn) | 0, Number(now & 0xffffffffn) | 0] }),
          TimeModified: ({ type: 'long', value: [Number((now >> 32n) & 0xffffffffn) | 0, Number(now & 0xffffffffn) | 0] }),
